...
{
    public class Jsonthird // Jsonthird hold Properties
    {
    ...
    class Program //This class have method, which contain logic for converting file from csv to json
    {
        static void Main(string[] args)
        {
            ...
            List<Jsonthird> stackedbar = new List<Jsonthird>();//creating list of type Jsonthird
            List<Jsonthird> sub = new List<Jsonthird>();
            string[] data = streamReader.ReadLine().Split(',');
            while (!streamReader.EndOfStream)
            {
                string[] data1 = streamReader.ReadLine().Split(',');// values hold the data separated by comma 
            ...
            //This query  is used for grouping the data by countryname
            thirdJson.WriteLine("[" + "\n");
